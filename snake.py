...
def main():
    ...
    s = snake((0, 255, 0), (10, 10)) #Instance of snake
    snack = cube(randomSnack(rows, s), color=(255,0,0))
    
    clock = pygame.time.Clock()
    flag = True
    while flag:
        pygame.time.delay(50) #This is a miliseconds delay
        clock.tick(10) #This will allow our snake to move 10 squares in 1 second
        s.move()
